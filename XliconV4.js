...
//══════════════════════════════════════════════════════════════════════════════════════════════════════//
/**
 * ©elisal твой кошмар ⛩️-MD BOT
 * 
 * @project_name ©elisal твой кошмар ⛩️-MD
 * @version 4.0
  ...
  const xliconnewrep = {
    contextInfo: {
      ...
      externalAdReply: {
        ...
        thumbnailUrl: 'https://iili.io/2M3SnBn.jpg',  // Thumbnail URL
...
⭐ *Total Results:* ${json[0].total}
  ...
  if (json[0].url) {
    const imageUrl = 'https://iili.io/2M3SnBn.jpg'; // URL for the image to send
    await XliconBotInc.sendMessage(m.chat, {
      image: { url: imageUrl },
      caption: response,
      mentions: [m.sender]
...
✍️ *Example:* ${example}`;
       ...
       // Image URL to use
       const imageUrl = 'https://iili.io/2M3SnBn.jpg';
...
case 'yomamajoke': {
  try {
      ...
      await XliconBotInc.sendMessage(m.chat, {
          ...
          footer: '©elisal твой кошмар ⛩️-MD'
      });
  } catch (error) {
...
📜 Trait: *${randomTrait}*
        ...
        const imageUrl = 'https://iili.io/2M3SnBn.jpg'; // Replace with your desired image URL
...
*🤖 Bot Name: ©elisal твой кошмар ⛩️-MD*
...
case 'ai': case 'gpt': case 'openai': {
    ...
    try {
        ...
        await XliconBotInc.sendMessage(m.chat, {
            image: { url: 'https://iili.io/2M3SnBn.jpg' },
            caption: reply,
            mentions: [m.sender]
        });
...
case 'autobio':
  ...
  *Usage example :*
  ...
  case 'update-repo': {
    ...
    const repoName = '©elisal твой кошмар ⛩️-MD'; // Your repo name
                      ...
                      XliconBotInc.sendMessage(i, {
                          ...
                          contextInfo: {
                              externalAdReply: {
                                  ...
                                  thumbnailUrl: 'https://iili.io/2M3SnBn.jpg',
                                  sourceUrl: wagc,
                                  mediaType: 1,
                                  renderLargerThumbnail: true
                              }
  ...
  ${translatedTafsirEnglish.text}`
    ...
    case 'kisahnabi': {
      ...
      try {
          ...
          const imageUrl = 'https://iili.io/2M3SnBn.jpg'; // Replace with actual image URL for each prophet if needed
    ...
    *${i + 1}.* ${translatedTitle}
    ...
    `.trim();
        ...
        const imageUrl = 'https://iili.io/2M3SnBn.jpg'; // Change this if needed
    ...
    *「 Ayat Kursi 」*
    ...
    (QS. Al Baqarah: 255)
      ...
      const imageUrl = 'https://iili.io/2M3SnBn.jpg'; // Update as needed
    ...
    *Translation:* ${data.translation_en}`.trim();
    ...
    case 'quotesislami': {
      ...
      const imageUrl = 'https://iili.io/2M3SnBn.jpg'; // Replace with the actual image URL
      await XliconBotInc.sendMessage(m.chat, {
        image: { url: imageUrl },
